...
class TeamUpdateTable extends _i1.UpdateTable<TeamTable> {
  ...
  _i1.ColumnValue<List<int>, List<int>> memberIds(List<int> value) =>
      _i1.ColumnValue(
        table.memberIds,
        value,
      );
...
class TeamTable extends _i1.Table<int?> {
  TeamTable({super.tableRelation}) : super(tableName: 'teams') {
    ...
    memberIds = _i1.ColumnSerializable<List<int>>(
      'memberIds',
      this,
    );
  ...
  late final _i1.ColumnSerializable<List<int>> memberIds;
