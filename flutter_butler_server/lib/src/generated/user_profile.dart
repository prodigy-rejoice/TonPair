...
import 'package:flutter_butler_server/src/generated/protocol.dart' as _i2;
...
class UserProfileUpdateTable extends _i1.UpdateTable<UserProfileTable> {
  ...
  _i1.ColumnValue<Map<String, String>, Map<String, String>> skillLevels(
  ...
  _i1.ColumnValue<String, String> availability(String value) => _i1.ColumnValue(
    table.availability,
    value,
  );
...
class UserProfileTable extends _i1.Table<int?> {
  UserProfileTable({super.tableRelation}) : super(tableName: 'user_profiles') {
    ...
    skillLevels = _i1.ColumnSerializable<Map<String, String>>(
      'skillLevels',
      this,
    );
  ...
  late final _i1.ColumnSerializable<Map<String, String>> skillLevels;
