...
--
-- Class Hackathon as table hackathons
--
...
--
-- Class MatchRequest as table match_requests
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('flutter_butler', '20260112000120532', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260112000120532', "timestamp" = now();
