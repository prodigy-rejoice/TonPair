...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:flutter_butler_server/src/generated/mach_result.dart' as _i5;
import 'package:flutter_butler_server/src/generated/match_request.dart' as _i6;
import 'package:flutter_butler_server/src/generated/user_profile.dart' as _i7;
import 'package:flutter_butler_server/src/generated/greetings/greeting.dart'
    as _i8;
...
class TestEndpoints {
  ...
  late final _MatchmakingEndpoint matchmaking;

  late final _MatchRequestEndpoint matchRequest;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    matchmaking = _MatchmakingEndpoint(
      endpoints,
      serializationManager,
    );
    matchRequest = _MatchRequestEndpoint(
      endpoints,
      serializationManager,
    );
...
class _MatchmakingEndpoint {
  _MatchmakingEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i5.MatchResult>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _MatchRequestEndpoint {
  _MatchRequestEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            ...
            method: 'sendMatchRequest',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'matchRequest',
          methodName: 'sendMatchRequest',
          parameters: _i1.testObjectToJson({
  ...
  _i3.Future<_i6.MatchRequest> respondToMatchRequest(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'matchRequest',
            method: 'respondToMatchRequest',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'matchRequest',
          methodName: 'respondToMatchRequest',
          parameters: _i1.testObjectToJson({
            'requestId': requestId,
            'accept': accept,
          }),
...
class _UserProfileEndpoint {
  ...
  _i3.Future<_i7.UserProfile> createProfile(
    _i1.TestSessionBuilder sessionBuilder,
  ...
  _i3.Future<_i7.UserProfile?> getProfile(
    _i1.TestSessionBuilder sessionBuilder,
    int id,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
